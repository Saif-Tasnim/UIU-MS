...
const CounsellingRequest = () => {
    ...
    const handleSubmit = (event) => {
        ...
        const data = {
            studentId: id, email, name, big, stime, etime, day
        }

        // console.log(data);

        axiosSecure.post('/counseling', data)
            .then(res => {
                                    ...
                                    <div className="modal-content max-w-full w-full flex flex-col gap-5 p-7 bg-gray-100">
                                        ...
                                        <form onSubmit={handleSubmit}>
                                                ...
                                                <div className='flex gap-8'>
                                                    ...
                                                    <div className="form-field">
                                                        ...
                                                        <input
                                                            ...
                                                            defaultValue={classes?.student_id}
                                                            readOnly
                                                            name="id"
                                                        />
                                                    ...
                                                    <div className="form-field">
                                                        ...
                                                        <div className="form-control">
                                                            <input
                                                                ...
                                                                defaultValue={classes?.student_email}
                                                                readOnly
                                                                name='email'
                                                            />
                                                        </div>
                                                    ...
                                                    <div className="form-field">
                                                        ...
                                                        <div className="form-control">
                                                            <input
                                                                ...
                                                                defaultValue={modalData?.facultyName}
                                                                readOnly
                                                                name='name'
                                                            />
                                                        </div>
                                            ...
                                            <div>
                                                ...
                                                <h1 className='text-xl font-bold text-center my-6'> Provide me your time </h1>
                                                ...
                                                <input type="text" name="day" id="" className='rounded-lg p-3' />
                                            </div>
